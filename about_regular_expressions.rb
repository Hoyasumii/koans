...
class AboutRegularExpressions < Neo::Koan
  ...
  def test_character_classes_give_options_for_a_character
    ...
    # |a| a[/[cbr]at/] -> Bagulho esquisito
    # Mas é sobre um método que recebe a, que seria um item de animals, e vai ver se esse valor bate com a expressão desejada
    assert_equal ["cat", "bat", "rat"], animals.select { |a| a[/[cbr]at/] }
    # Nesse caso, zat não entra
  end
