...
class AboutIteration < Neo::Koan
  ...
  def test_inject_will_blow_your_mind
    ...
    # Eu pensei em fazer isso, otário!
    # Basicamente, o inject vai funcionar como um reducer, que vai percorrer um iterável e processar de acordo com a necessidade
  end
